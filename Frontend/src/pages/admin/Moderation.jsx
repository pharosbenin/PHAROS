      ...
      <div className="flex-1 min-w-0 p-6 lg:p-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
          {[
            ...
            { label: 'Avis à approuver', valeur: nbAvisAttente, icon: ShieldAlert, couleur: 'text-blue-600', bg: 'bg-blue-50' },
            { label: 'Total en attente', valeur: nbSignalements + nbAvisAttente, icon: AlertTriangle, couleur: 'text-red-500', bg: 'bg-red-50' },
            { label: 'Avis traités', valeur: '—', icon: CheckCircle, couleur: 'text-green-600', bg: 'bg-green-50' },
          ].map((s, i) => (
